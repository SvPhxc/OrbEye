# hardware_controller.py (Corrected for Background Scan and Rotational Control)
...
# --- CODE REPAIRED HERE ---
# Relaxed the target threshold. 0.05 degrees was too strict for a physical
# system with high PID gains, causing it to get stuck trying to achieve
# impossible precision. 0.5 is a much more practical value.
...
class HardwareController:
    ...
    # --- CODE REPAIRED HERE ---
    # Added a helper function to correctly calculate the shortest angular error
    # for the pan axis, respecting the 0/360 wrap-around.
    def _get_shortest_pan_error(self, setpoint, current_value):
        """Calculates the shortest angular distance for the pan axis in degrees."""
    ...
    def run(self):
        ...
        try:
            ...
            while not self.shared_data["shutdown"].value:
                ...
                # --- CODE REPAIRED HERE ---
                # Replaced the simple `abs()` check with the proper rotational error check.
