...
class TrackerWindow(QtWidgets.QMainWindow):
    def __init__(self, shared_data):
        ...
        # Make the window a bit bigger to fit heatmap under 3D
        ...
        # (Was created but not added before) — add Reactive Mode checkbox to layout
    ...
    def clear_heatmap(self):
        ...
        self.hm_img.setImage(self.hm_bins[::-1, :].T, autoLevels=True)
    ...
    def update_pan_tilt_heatmap(self):
        ...
        if mx <= 0.0:
            mx = 1.0
        img = (self.hm_bins / mx)[::-1, :].T  # shape: 360 x 91
